            ...
            <div class="mb-4">
                ...
                <select name="akses" id="akses" 
                    ...
                    @foreach($roles as $role)
                        <option value="{{ $role }}" {{ old('akses') == $role ? 'selected' : '' }}>{{ $role }}</option>
                    @endforeach
                </select>
                @error('akses')
                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
            ...
            <div class="mb-4">
                ...
                <select name="kecamatan_id" id="kecamatan_id" 
                    ...
                    @foreach($kecamatans as $kecamatan)
                        <option value="{{ $kecamatan->kode_kecamatan }}" {{ old('kecamatan_id') == $kecamatan->kode_kecamatan ? 'selected' : '' }}>{{ $kecamatan->nama_kecamatan }}</option>
                    @endforeach
                </select>
                @error('kecamatan_id')
                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
