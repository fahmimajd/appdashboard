...
@section('title', 'Input Data Kependudukan')
@section('subtitle', 'Form statistik kependudukan semesteran')
...
<div class="max-w-5xl mx-auto bg-white rounded-xl shadow-lg border border-gray-100 p-8">
    <div class="mb-6 pb-6 border-b border-gray-100">
        ...
        <h2 class="text-xl font-bold text-gray-800">Input Data Kependudukan</h2>
    </div>
    ...
    <form action="{{ route('kependudukan.store') }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div class="bg-blue-50 p-4 rounded-lg">
                ...
                <input type="number" min="0" id="jumlah_penduduk" name="jumlah_penduduk" value="{{ old('jumlah_penduduk') }}" 
                       class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 transition duration-200">
            ...
            <div class="bg-gray-50 p-4 rounded-lg">
                 ...
                 <input type="number" min="0" id="jumlah_laki" name="jumlah_laki" value="{{ old('jumlah_laki') }}" 
            ...
            <div class="bg-gray-50 p-4 rounded-lg">
                 ...
                 <input type="number" min="0" id="jumlah_perempuan" name="jumlah_perempuan" value="{{ old('jumlah_perempuan') }}" 
                        class="w-full rounded-lg border-gray-300 focus:border-blue-500 transition">
            ...
            <div class="bg-gray-50 p-4 rounded-lg">
                 ...
                 <input type="number" min="0" id="kartu_keluarga" name="kartu_keluarga" value="{{ old('kartu_keluarga') }}" 
                        class="w-full rounded-lg border-gray-300 focus:border-blue-500 transition">
            </div>
            <div class="bg-gray-50 p-4 rounded-lg">
                 <label for="wajib_ktp" class="block text-sm font-medium text-gray-700 mb-2">Jumlah Wajib KTP</label>
                 <input type="number" min="0" id="wajib_ktp" name="wajib_ktp" value="{{ old('wajib_ktp') }}" 
                        class="w-full rounded-lg border-gray-300 focus:border-blue-500 transition">
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            <div>
                 ...
                 <input type="number" min="0" id="akta_kelahiran_jml" name="akta_kelahiran_jml" value="{{ old('akta_kelahiran_jml') }}" 
                        class="w-full rounded-lg border-gray-300">
            </div>
            <div>
                 <label for="kepemilikan_ktp_jml" class="block text-sm font-medium text-gray-700 mb-2">Jml Kepemilikan KTP</label>
                 <input type="number" min="0" id="kepemilikan_ktp_jml" name="kepemilikan_ktp_jml" value="{{ old('kepemilikan_ktp_jml') }}" 
                        class="w-full rounded-lg border-gray-300">
            </div>
            <div>
                 <label for="kepemilikan_kia_jml" class="block text-sm font-medium text-gray-700 mb-2">Jml Kepemilikan KIA</label>
                 <input type="number" min="0" id="kepemilikan_kia_jml" name="kepemilikan_kia_jml" value="{{ old('kepemilikan_kia_jml') }}" 
                        class="w-full rounded-lg border-gray-300">
            </div>
            <div>
                 <label for="akta_kematian_jml" class="block text-sm font-medium text-gray-700 mb-2">Jml Akta Kematian</label>
                 <input type="number" min="0" id="akta_kematian_jml" name="akta_kematian_jml" value="{{ old('akta_kematian_jml') }}" 
                        class="w-full rounded-lg border-gray-300">
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div>
                 ...
                 <input type="number" min="0" id="jumlah_kematian" name="jumlah_kematian" value="{{ old('jumlah_kematian') }}" 
                        class="w-full rounded-lg border-gray-300">
            </div>
            <div>
                 <label for="pindah_keluar" class="block text-sm font-medium text-gray-700 mb-2">Jumlah Pindah</label>
                 <input type="number" min="0" id="pindah_keluar" name="pindah_keluar" value="{{ old('pindah_keluar') }}" 
                        class="w-full rounded-lg border-gray-300">
            </div>
            <div>
                 <label for="status_kawin_jml" class="block text-sm font-medium text-gray-700 mb-2">Jumlah Status Kawin</label>
                 <input type="number" min="0" id="status_kawin_jml" name="status_kawin_jml" value="{{ old('status_kawin_jml') }}" 
                        class="w-full rounded-lg border-gray-300">
            </div>
        </div>
