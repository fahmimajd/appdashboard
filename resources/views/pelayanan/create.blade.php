...
@section('title', 'Buat Data Pelayanan')
@section('subtitle', 'Input nomor pelayanan atau pengaduan baru')
...
<div class="max-w-2xl mx-auto bg-white rounded-xl shadow-lg border border-gray-100 p-8">
    <div class="mb-6 pb-6 border-b border-gray-100">
        ...
        <h2 class="text-xl font-bold text-gray-800">Buat Nomor Baru</h2>
    </div>
    ...
    <form action="{{ route('pelayanan.store') }}" method="POST">
        ...
        <div class="space-y-6">
            <div class="bg-blue-50 p-4 rounded-lg border border-blue-100">
                 ...
                 <input type="text" id="nomor_pelayanan" name="nomor_pelayanan" value="{{ old('nomor_pelayanan') }}" placeholder="Contoh: PL-2023-001"
                        class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 transition duration-200">
                 <p class="text-xs text-gray-500 mt-1">Dapat dikosongkan jika hanya input pengaduan.</p>
            ...
            <div class="bg-yellow-50 p-4 rounded-lg border border-yellow-100">
                 ...
                 <input type="text" id="nomor_pengaduan" name="nomor_pengaduan" value="{{ old('nomor_pengaduan') }}" placeholder="Contoh: ADU-2023-001"
                        class="w-full rounded-lg border-gray-300 focus:border-yellow-500 focus:ring focus:ring-yellow-200 transition duration-200">
                 <p class="text-xs text-gray-500 mt-1">Dapat dikosongkan jika hanya input pelayanan.</p>
