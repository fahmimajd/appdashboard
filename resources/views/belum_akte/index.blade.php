...
<div class="bg-white rounded-xl shadow-lg border border-gray-100 p-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        ...
        <!-- Actions -->
        <div>
            @if(request('search') || request('kode_kecamatan') || request('kode_desa'))
                <a href="{{ route('belum_akte.index') }}" class="mr-2 px-4 py-2 bg-gray-100 text-gray-600 rounded-lg hover:bg-gray-200 transition duration-200">
                    Reset
                </a>
            @endif
        </div>
