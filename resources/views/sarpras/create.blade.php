...
@section('subtitle', 'Input data infrastruktur desa')
...
<div class="max-w-3xl mx-auto bg-white rounded-xl shadow-lg border border-gray-100 p-8">
    <div class="mb-6 pb-6 border-b border-gray-100">
        ...
        <h2 class="text-xl font-bold text-gray-800">Tambah Data Sarpras Desa</h2>
    </div>
    ...
    <form action="{{ route('sarpras.store') }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div>
                ...
                <input type="number" min="0" id="komputer" name="komputer" value="{{ old('komputer', 0) }}" 
                       class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 transition duration-200">
            ...
            <div>
                ...
                <input type="number" min="0" id="printer" name="printer" value="{{ old('printer', 0) }}" 
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div>
                 ...
                 <select id="ruang_pelayanan" name="ruang_pelayanan" class="w-full rounded-lg border-gray-300">
                     <option value="Ada" {{ old('ruang_pelayanan') == 'Ada' ? 'selected' : '' }}>Ada</option>
                     <option value="Tidak" {{ old('ruang_pelayanan') == 'Tidak' ? 'selected' : '' }}>Tidak</option>
                 </select>
            </div>
             <div>
                ...
                <input type="number" min="0" id="internet" name="internet" value="{{ old('internet', 0) }}" 
            ...
            <div class="md:col-span-2">
                ...
                <input type="text" id="provider" name="provider" value="{{ old('provider') }}" placeholder="Contoh: Telkom Indihome, Biznet..."
                       class="w-full rounded-lg border-gray-300 focus:border-blue-500">
