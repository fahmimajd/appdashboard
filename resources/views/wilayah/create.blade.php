...
@section('subtitle', 'Form penambahan data wilayah desa baru')
...
<div class="max-w-4xl mx-auto bg-white rounded-xl shadow-lg border border-gray-100 p-8">
    <div class="mb-6 pb-6 border-b border-gray-100">
        ...
        <h2 class="text-xl font-bold text-gray-800">Formulir Desa Baru</h2>
    </div>
    ...
    <form action="{{ route('wilayah.store') }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <!-- Kode Desa -->
            <div>
                <label for="kode_desa" class="block text-sm font-medium text-gray-700 mb-2">Kode Desa <span class="text-red-500">*</span></label>
                <input type="text" id="kode_desa" name="kode_desa" value="{{ old('kode_desa') }}" placeholder="Contoh: 12.13.01.2001" 
                       class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 transition duration-200 @error('kode_desa') border-red-500 @enderror">
                @error('kode_desa')
            ...
            <div>
                ...
                <input type="text" id="nama_desa" name="nama_desa" value="{{ old('nama_desa') }}" placeholder="Contoh: Desa Suka Maju" 
            ...
            <div>
                ...
                <input type="text" id="kepala_desa" name="kepala_desa" value="{{ old('kepala_desa') }}" placeholder="Nama Lengkap" 
            ...
            <div>
                ...
                <input type="text" id="telepon_desa" name="telepon_desa" value="{{ old('telepon_desa') }}" placeholder="0812..." 
                       class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 transition duration-200">
            </div>
            ...
            <div class="md:col-span-2">
                ...
                <input type="email" id="email_desa" name="email_desa" value="{{ old('email_desa') }}" placeholder="desa@example.com" 
            ...
            <div class="md:col-span-2">
                ...
                <textarea id="alamat_kantor" name="alamat_kantor" rows="3" placeholder="Jl. Raya Desa No. 1..." 
                          class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 transition duration-200">{{ old('alamat_kantor') }}</textarea>
            </div>
            ...
            <div class="md:col-span-2">
                ...
                <div class="flex gap-4">
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="radio" name="status_desa" value="1" {{ old('status_desa', '1') == '1' ? 'checked' : '' }} class="text-blue-600 focus:ring-blue-500">
                        <span class="text-sm text-gray-700">Aktif</span>
                    </label>
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="radio" name="status_desa" value="0" {{ old('status_desa') == '0' ? 'checked' : '' }} class="text-blue-600 focus:ring-blue-500">
